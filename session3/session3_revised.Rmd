...
2. Create an output table showing the number of trips as a percentage of all trips taken by calendar year
3 . **Stretch**: Modify the table created above to show the percentages rounded to the nearest whole number
