...
write_csv(iris_petals, path = "iris_petals_uds.csv")

```



This assumes by default that the columns are separated by a comma symbol (sep = ","). The data will be saved as a CSV in your working directory.
